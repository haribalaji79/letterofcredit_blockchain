...
var chain_name = 'lc_chaincode';
var chaincode_path = 'chaincode/';
var deployWaitTime = 30;

module.exports.setupChain = function (keyValStoreDir, users, peerURLs, peerEventHosts, caURL, certificate, certificate_path, cb) {
    ...
    configure_network(chain, peerURLs, peerEventHosts, caURL, registrarCredentials, certificate, function (err, registrar) {
        if (err) {
 ...
 */
function configure_network(chain, peerURLs, peerEventHosts, caURL, registrarCredentials, certificate, cb) {
