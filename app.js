...
try {
    ...
    for (var i in peers) {
        ...
        peerEventHosts.push(prefix + peers[i].event_host+ ":" + peers[i].event_port);
    }
    var ca = manual.ca;
    for (var i in ca) {
...
chain_setup.setupChain(keyValStoreDir, users, peerURLs, peerEventHosts, caURL, certificate, certificate_path,
